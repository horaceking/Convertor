...
public class Length extends TypeFragment {
	...
	//Set the names with this type
		...
		public void doSomethingOnCreate() {
			// TODO Auto-generated method stub
			super.showButton("gongzhi","yingzhi",
					getActivity().getResources().getStringArray(R.array.temperature1),
					getActivity().getResources().getStringArray(R.array.temperature_m1));
		}
}
